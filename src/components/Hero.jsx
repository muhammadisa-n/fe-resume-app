  ...
  return (
    <>
      <nav className="h-20">
        <div className="fixed left-0 top-0 right-0 z-100 flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white transition-all">
          ...
          <div className="hidden sm:flex items-center gap-4 md:gap-8 max-md:text-sm text-gray-800">
            ...
            <a href="#features" onClick={() => scrollTo(0, 0)}>
              {" "}
              Features{" "}
            </a>
          </div>
        ...
        >
          <div className="flex flex-col items-center justify-center h-full text-xl font-semibold gap-6 p-4">
            ...
            <a href="#feature" onClick={() => scrollTo(0, 0)}>
              {" "}
              Features{" "}
            </a>
            <Link
      ...
      <div className="rethink relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-gray-800">
        {/* Headline */}
        <h1 className="text-4xl md:text-6xl font-semibold max-w-lg md:max-w-2xl text-center mt-64 leading-tight md:leading-tight">
          Build Your{" "}
        ...
        <p className="max-w-xl text-center text-base my-7">
          Create a stunning, jon-winning resume effortlessly with out intuitive
          builder, choose from modern templates, customize your content, and
          export your resume in just a few clicks-no design skills required.
        </p>

        {/* Login Box */}
        <Link
          to={"/login"}
          className="bg-indigo-600 text-white p-3 px-6 rounded-md cursor-pointer"
        >
          {" "}
          Login{" "}
        </Link>
